...
class ErrorPage extends Component {
  render() {
    return (
      <>
        <div id={ErrorStyle.errorWrapper}>
          <Container id={ErrorStyle.eCon}>
            <Row id={ErrorStyle.eRow}>
              <Col id={ErrorStyle.eCol}>
                <div id={ErrorStyle.eh1}>ERROR 1203499C0005ƆB</div>
              </Col>
            </Row>

            <Row id={ErrorStyle.eRow}>
              <div id={ErrorStyle.eh2}>
                Well'p, now you did it. Broke the damn computer. You probably
                didn't even do anything major, did you? But see, I'm the dreaded
                Blue Screen of Death, and I pop up totally randomly, and most
                times, for no gah-darn reason.
              </div>
            </Row>
              ...
              <ul>
                <li>
                  <div id={ErrorStyle.eh2}>
                    ...
                    you've done on me up until this point will be gone. Sucks,
                    right?! But if you're into downloading weird online GIF's
            ...
            <Row>
              <Fade delay={18000}>
                <Link to="/">
                  <Button id={ErrorStyle.eHomeButton}>Home</Button>
                </Link>
              </Fade>
            </Row>
          </Container>
